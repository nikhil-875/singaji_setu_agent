...
from utils.ui_components import display_extra_details, get_default_schema
...
def render_review_tab():
    ...
    if st.session_state.transcript:
        ...
        edited = st.text_area(
            ...
            value=st.session_state.edited_transcript or st.session_state.transcript,
            height=300,
        ...
        st.download_button(
            ...
            data=st.session_state.edited_transcript or st.session_state.transcript,
...
def render_payload_tab():
    ...
    transcript_to_use = (
        st.session_state.edited_transcript or st.session_state.transcript
    )
